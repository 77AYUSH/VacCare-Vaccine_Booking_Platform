...
<head>
        <title>VacCare || Login Page</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form class="form-vertical" method="post">
				 <div class="control-group normal_text"> <h3><img src="img/vacc.png" alt="Logo" /></h3></div>
            ...
            <form id="recoverform" action="#" class="form-vertical"  method="post" name="chngpwd" onSubmit="return valid();">
				<p class="normal_text">Enter your below details and we will send you instructions how to recover a password.</p>
