...
<html lang="en">
<head>
<title>VacCare || Vaccination Booking Form</title>
<meta charset="UTF-8" />
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form method="post" class="form-horizontal">
              ...
              <div class="control-group">
                <label class="control-label">Goverment approved   ID Proof :<br>Must carry at time of vaccination</label>
                <div class="controls">
...
{               ?>
  ...
  <?php $cnt=$cnt+1;}} ?>
              ...
              <div class="control-group">
                <label class="control-label">Select the Vaccine Center</label>
                <div class="controls">
...
{               ?>
  ...
  <?php $cnt=$cnt+1;}} ?>
              ...
              <div class="control-group">
                <label class="control-label">Date of Vaccination :</label>
                <div class="controls">
              ...
              <div class="control-group">
                <label class="control-label">Type of Dose :</label>
                <div class="controls">
