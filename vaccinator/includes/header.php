...
<div id="sidebar"><a href="dashboard.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a><ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-fullscreen"></i> <span>Vaccination Booking</span> </a>
      <ul>
        <li><a href="new-vaccine-booking.php">New Booking</a></li>
        <li><a href="all-vaccination-booking.php">All Booking</a></li>
        <li><a href="vaccination-done.php">Vaccination Compeleted</a></li>
      </ul>
    </li>
