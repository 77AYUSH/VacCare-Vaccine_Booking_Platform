...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="profile.php" class="tip-bottom">Your Profile Details</a> </div>
...
{               ?>
              <div class="control-group">
                <label class="control-label">Vaccination Center Name :</label>
                <div class="controls">
             ...
             <div class="control-group">
              ...
              <div class="control-group">
                <label class="control-label">Number of Years of Experience :</label>
                <div class="controls">
