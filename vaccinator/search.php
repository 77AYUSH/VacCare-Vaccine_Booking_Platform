...
<html lang="en">
<head>
<title>VacCare|| Search Vaccination Request</title>
<meta charset="UTF-8" />
...
$sql="SELECT * from tblvaccinationbooking where (VaccineCenterid=:vcenid) && (BookingNumber like '%$sdata%' || Name like '%$sdata%' || MobileNumber like '%$sdata%')";
